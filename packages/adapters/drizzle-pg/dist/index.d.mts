...
import { settingSchema, userSchema, forumSchema, threadSchema, postSchema } from './schema/index.mjs';
import 'drizzle-orm/node-postgres';

interface ReactForumsDrizzleSchema<TSettingTable extends PgTable = typeof settingSchema, TUserTable extends PgTable = typeof userSchema, TForumTable extends PgTable = typeof forumSchema, TThreadTable extends PgTable = typeof threadSchema, TPostTable extends PgTable = typeof postSchema> {
...
declare const defaultSchema: {
    settings: drizzle_orm_pg_core.PgTableWithColumns<{
        name: "rf_settings";
        schema: undefined;
        columns: {
    ...
    posts: drizzle_orm_pg_core.PgTableWithColumns<{
        name: "rf_posts";
        schema: undefined;
        columns: {
            id: drizzle_orm_pg_core.PgColumn<{
            ...
            parentPostId: drizzle_orm_pg_core.PgColumn<{
                name: "parent_post_id";
                tableName: "rf_posts";
                dataType: "number";
                columnType: "PgInteger";
            ...
            editUserId: drizzle_orm_pg_core.PgColumn<{
                name: "edit_user_id";
                tableName: "rf_posts";
                dataType: "number";
                columnType: "PgInteger";
            ...
            longIpAddress: drizzle_orm_pg_core.PgColumn<{
                name: "long_ip_address";
                tableName: "rf_posts";
                dataType: "string";
                columnType: "PgVarchar";
                data: string;
            ...
            includeSignature: drizzle_orm_pg_core.PgColumn<{
